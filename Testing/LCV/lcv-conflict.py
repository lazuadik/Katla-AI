...
def main():
    # words_target = [word.upper() for word in open("Testing/LCV/sample-lcv-2.txt", "r").read().split("\n")]
    ...
    open("Testing/LCV/Result/lcv-conflict.txt", "w").writelines(lines)

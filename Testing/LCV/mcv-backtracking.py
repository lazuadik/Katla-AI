...
class WordleGuesser:
    ...
    def lcv(self, var, assignment):
        ...
        return sorted(self.csp.choices(var), key=lambda val: comb - self.csp.trie.count_leaf(assignment, val), reverse=True)
...
def main():
    ...
    open("Testing/LCV/Result/mcv-backtracking.txt", "w").writelines(lines)

...
def main():
    # words_target = [word.upper() for word in open("Testing/LCV/sample-lcv.txt", "r").read().split("\n")]
    ...
    open("Testing/LCV/Result/no-ordering-convergence.txt", "w").writelines(lines)

...
def main():
    ...
    open("Testing/forward checking/Result/no-filtering-backtracking.txt", "w").writelines(back_lines)
    open("Testing/forward checking/Result/no-filtering-conflict.txt", "w").writelines(conf_lines)
